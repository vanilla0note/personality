...
function filter_ready() {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: {            
            myckeck_filter_mood_date01_val: $("#filter-mood-date01").val(),
            myckeck_filter_mood_date02_val: $("#filter-mood-date02").val(),
            myckeck_filter_mood_id_val: $("#filter-mood-id").val(), 
            myckeck_filter_mood_name_val: $("#filter-mood-name").val(),
            myckeck_filter_mood_area_val: $("#filter-mood-area").val(),
            myckeck_filter_mood_dep_val: $("#filter-mood-dep").val(),
            myckeck_filter_mood_state_val: $("#filter-mood-state").val(),                      
        },
